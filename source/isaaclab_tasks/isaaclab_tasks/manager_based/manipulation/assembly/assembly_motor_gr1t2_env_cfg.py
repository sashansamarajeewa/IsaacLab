...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    #     spawn=UsdFileCfg(usd_path="/workspace/isaaclab/source/isaaclab_assets/isaaclab_assets/assembly/motor/part6.usd",
    #                      scale=ASSET_SCALE,
    #                      rigid_props=sim_utils.RigidBodyPropertiesCfg(),
    #                      ),
    # )
...
@configclass
class AssemblyMotorGR1T2EnvCfg(ManagerBasedRLEnvCfg):
